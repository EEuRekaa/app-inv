<?php
   ...
   if (isset($_GET['verification'])) {
      if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM admin_account WHERE v_code='{$_GET['verification']}'")) > 0) {
         $query = mysqli_query($conn, "UPDATE admin_account SET v_code='' WHERE v_code='{$_GET['verification']}'");
