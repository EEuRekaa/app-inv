                  ...
                  <div class="col-sm-12">
                     <div class="card mb-0">
                        <div class="card-header">
                           ...
                           <a href="./zadmin_register.php" class="btn btn-info"><i class="la la-plus-circle"></i> Tambahkan Data Admin</a>
                        </div>
                        <div class="card-body">
                           <div class="table-responsive">
                              <table class="datatable table table-stripped mb-0">
                                 ...
                                 <tbody>
                                    ...
                                    $query = mysqli_query(
                                        $conn,
                                        "SELECT * FROM admin_account ORDER BY id_admin desc"
                                    );
                                    while (
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-center">
                                          <a href="adminedit.php?id_admin=<?php echo $data[
                                              "id_admin"
                                          ]; ?>">
                                          ...
                                          <a href="delete_admin.php?id_admin=<?php echo $data[
                                              "id_admin"
                                          ]; ?>">
