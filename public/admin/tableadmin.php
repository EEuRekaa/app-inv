                                 ...
                                 ?>
                                    <tr>
                                       ...
                                       <td class="text-center">
                                          <a href="./addadmin.php"><button class="btn btn-outline-info">ADD</button></a>
                                          <a href="form-add.php?id_admin=<?php echo $data['id_admin'];?>"><button class="btn btn-outline-primary">EDIT</button></a>
                                          <a href="delete_admin.php?id_admin=<?php echo $data['id_admin'];?>"><button class="btn btn-outline-danger">DELETE</button></a>
                                       </td>
                                    </tr>
                                 <?php } ?>
                                 </tbody>
