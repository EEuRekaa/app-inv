                  ...
                  <div class="col-sm-12">
                     <div class="card mb-0">
                        <div class="card-header">
                           <h4 class="card-title mb-0 text-right"><a href="./addadmin.php" class="btn btn-info"><i class="la la-plus-circle"></i> Tambahkan Data Admin</a>
                        ...
                        <div class="card-body">
                           <div class="table-responsive">
                              <table class="datatable table table-stripped mb-0">
                                 ...
                                 $no="1";
                                 $query = mysqli_query($conn, "SELECT * FROM admin_account ORDER BY id_admin DESC");
                                 ...
                                 ?>
                                    <tr>
                                       ...
                                       <td class="text-center">
                                          <a href="adminedit.php?id_admin=<?php echo $data['id_admin'];?>"><button class="btn btn-outline-primary">EDIT</button></a>
                                          ...
                                          <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                             <div class="modal-dialog">
                                                <div class="modal-content">
                                                   ...
                                                   <h4 class="modal-title" id="exampleModalLabel">Hapus Data Admin</h4>
                                                   <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                      <span aria-hidden="true">&times;</span>
                                                   </button>
                                                   </div>
                                                   <div class="modal-body">
                                                   <h4>Anda yakin ingin menghapus data admin ini?</h4>
                                                   </div>
                                                   <div class="modal-footer">
                                                   <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                   <a href="delete_admin.php?id_admin=<?php echo $data['id_admin'];?>"><button type="button" class="btn btn-primary">Konfirmasi</button></a>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
