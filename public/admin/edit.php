...
<body>
    ...
    ?>
        <form action="update.php?id_account=<?php echo $id_account ?>" method="post">            
            <div class="flex items-center justify-around h-screen w-screen">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="username" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:shadow-outline" value="<?php echo $username; ?>" required>
                </div>
                <div class="mb-4">
                    <label for="" class="block text-gray-700 text-base font-bold mb-2">Email</label>
                    <input type="email" name="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:shadow-outline" value="<?php echo $email; ?>" required>
                </div>
                <div class="mb-4">
                    <label for="" class="block text-gray-700 text-base font-bold mb-2">Password</label>
                    <input type="password" name="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:shadow-outline" value="<?php echo $password; ?>" required>"
                </div>
                <div class="mb-4">
