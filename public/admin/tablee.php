                  ...
                  <div class="col-sm-12">
                     <div class="card mb-0">
                        <div class="card-header">
                           <h4 class="card-title mb-0 text-right"><a href="./zadmin_register.php" class="btn btn-info"><i class="la la-plus-circle"></i> Tambahkan Data User</a></h4>
                        </div>
                        <div class="card-body">
                           <div class="table-responsive">
                              <table class="datatable table table-stripped mb-0">
                                 ...
                                 <tbody>
                                    ...
                                    $query = mysqli_query(
                                        $conn,
                                        "SELECT * FROM user_account ORDER BY id_user desc"
                                    );
                                    while (
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-center">
                                          <a href="form-add.php?id_user=<?php echo $data[
                                              "id_user"
                                          ]; ?>">
                                          ...
                                          <a href="delete_user.php?id_user=<?php echo $data[
                                              "id_user"
                                          ]; ?>">
