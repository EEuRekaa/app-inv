<?php 
   ...
   if (isset($_POST['submit'])) {
      ...
      $mail->setFrom('INVATE@invate.my.id');
               ...
               $mail->Body    = 'Click link untuk verifikasi<b><a href="http://localhost/app-inv/public/A_admin_login/admin_login.php?verification='.$v_code.'">  http://localhost/app-inv/public/A_admin_login/admin_login.php?verification='.$v_code.'</a></b>';
