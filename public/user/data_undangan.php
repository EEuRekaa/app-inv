...
<html lang="en">
   ...
   <body>
      ...
      <?php
         ...
         ?>
         <a href="./index.php?"><h4 class="text-right px-5">tambah undangan</h4></a>
      <table class="table">
         <thead>
            <tr>
               <th scope="col">#</th>
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  ...
                  <a href="tamu_kirim.php?id_tamu=<?php echo $data['id_tamu']?>&id_undangan=<?php echo $data['id_tamu'] ?>"><button class="btn btn-outline-primary">Kirim ke tamu</button></a>
                  <!-- Modal -->
