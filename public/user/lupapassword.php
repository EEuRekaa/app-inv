...
if (isset($_POST["submit"])) {
    ...
    if (
        ...
        $query = mysqli_query(
            $conn,
            "UPDATE user_account SET v_code = '{$v_code}' WHERE email = '{$email}'"
        );
  ...
  <div class="container">
    ...
    <b style="text-align: center;><a style="text-align: center; text-decoration: italy;" href="http://localhost/app-inv/public/user/ubahpassword.php?reset=' .
                    $v_code .
                    '"> http://localhost/app-inv/public/user/ubahpassword.php?reset=' .
                    $v_code .
                    '</a></b>
    </div>
  </div>
