...
if (
    ...
    in_array($_REQUEST["level"], ["L", "M", "Q", "H"])
) {
...
echo '<form action="index.php" method="post">
    ...
    '" />&nbsp;
        ECC:&nbsp;<select name="level">
            <option value="L"' .
    ($errorCorrectionLevel == "L" ? " selected" : "") .
    '>L - smallest</option>
            <option value="M"' .
    ($errorCorrectionLevel == "M" ? " selected" : "") .
    '>M</option>
            <option value="Q"' .
    ($errorCorrectionLevel == "Q" ? " selected" : "") .
    '>Q</option>
            <option value="H"' .
    ($errorCorrectionLevel == "H" ? " selected" : "") .
    '>H - best</option>
        </select>&nbsp;
